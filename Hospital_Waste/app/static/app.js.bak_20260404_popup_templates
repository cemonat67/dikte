...
function openVisualPopup(type){
  ...
  if(type === "intake"){
    ...
    content.innerHTML = `
      <div style="padding:12px;">
        <h2>Intake Hub</h2>
        <p>Hospital onboarding ve veri giriş akışı burada yönetilir.</p>
      </div>
    `;
  }
  ...
  if(type === "reports"){
    ...
    content.innerHTML = `
      <div style="padding:12px;">
        <h2>Executive Reports Center</h2>
        <p>Yönetici raporları ve PDF çıktıları burada hazırlanır.</p>
      </div>
    `;
  }
